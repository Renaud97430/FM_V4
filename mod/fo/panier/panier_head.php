...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function handleProductInputBlur(event) {
            ...
            if(value == 0) {
                window.location.href = `index.php?page=panier&del_id_produit=${attrValue}`;
            }else {
                window.location.href = `index.php?page=panier&update_panier=1&id_produit=${attrValue}&new_qte=${encodeURIComponent(value)}`;
            }
        }
