<?php
    ...
    class Page{
        ...
        private function build_header($title,$link){
            ...
            $this->header.= '        </a>';
            $this->header.= '        <a href="index.php?page=listing_menu">';
            $this->header.= '            <img src="images/interface/menu.png" /><br/>Menu';
            $this->header.= '        </a>';
            $this->header.= '       <a href="index.php?page=listing_photo">';
            $this->header.= '            <img src="images/interface/galerie.png" /><br/>Photos';
            $this->header.= '        </a>';
            ...
            $this->header.= '            <img src="images/interface/shop.png" /><br/>Boutique';
            $this->header.= '        </a>';
            $this->header.= '       <a href="index.php?page=maze">';
            $this->header.= '            <img src="images/interface/maze.png" /><br/>Labyrinthe';
            $this->header.= '        </a>';
            $this->header.= '    </div>';
